...
class block_calendar_month extends block_base {
    ...
    public function get_content() {
        ...
        if ($issite) {
            // For the front page.
            $this->content->text .= calendar_get_mini($courses, $group, $user, false, false, 'display', $courseid, $time_a);
            $this->content->text .= calendar_get_mini($courses, $group, $user, false, false, 'frontpage', $courseid, $time);
            $this->content->text .= calendar_get_mini($courses, $group, $user, false, false, 'display', $courseid, $time_p);
            // No filters for now.
        } else {
            $this->content->text .= calendar_get_mini($courses, $group, $user, false, false, 'display', $courseid, $time_a);
